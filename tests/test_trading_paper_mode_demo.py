...
class TradingPaperDemoTests(unittest.TestCase):
    def test_trading_demo_deterministic(self):
    ...
    def test_trading_demo_refusal(self):
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            result = _run_cmd(
                [
                    ...
                    str(FIXTURES / "price_series_simple.json"),
                    "--policy",
                    str(FIXTURES / "policy_forbidden.json"),
                    "--signing-key",
                    str(TEST_KEY),
